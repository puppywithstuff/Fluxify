...
if (!window.__asteroidsBookmarkletRunning) {
    ...
    function spawnFragment(x,y,r){
        asteroids.push({x,y,r, vx:rand(-2,2), vy:rand(-2,2), verts: Math.floor(rand(6,10)), offs:Array.from({length:Math.floor(rand(6,10))},()=>rand(0.6,1.4))});
    }
...
// At the very bottom of asteroids.js

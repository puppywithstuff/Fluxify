...
// At the very end of asteroids.js
window.stopAsteroids = function() {
  if (window.cleanupAsteroids) cleanupAsteroids(); // Calls the proper cleanup
};

stopBtn.addEventListener('click', ev => {
  ev.stopPropagation(); // Prevent the click from bubbling to canvas
  if (typeof window.stopAsteroids === "function") {
    window.stopAsteroids();
    alert("Asteroids stopped!");
  } else {
    alert("Asteroids not running yet.");
  }
});
